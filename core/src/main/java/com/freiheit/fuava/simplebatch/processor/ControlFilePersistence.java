 ...
 * @param <Output>
 */
class ControlFilePersistence<Input> extends AbstractSingleItemProcessor<Input, FilePersistenceOutputInfo, ControlFilePersistenceOutputInfo> {
    ...
    @Override
    public Result<Input, ControlFilePersistenceOutputInfo> processItem(Result<Input, FilePersistenceOutputInfo> r) {
        if (r.isFailed()) {
