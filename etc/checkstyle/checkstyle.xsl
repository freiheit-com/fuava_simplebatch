...
<xsl:template match="checkstyle">
    ...
    h2 {
      ...
      <tr>
    	...
    	<hr size="1"/>
			...
			<!-- Summary part -->
			<xsl:apply-templates select="." context="summary"/>
			<hr size="1" width="100%" align="left"/>
			
			<!-- Package List part -->
			<xsl:apply-templates select="." context="filelist"/>
			<hr size="1" width="100%" align="left"/>
	...
	<xsl:template match="checkstyle" context="filelist">
		<h2>Files</h2>
	...
	<xsl:template match="checkstyle" context="summary">
		<h2>Summary</h2>
